...
conns = project.connections.list()
for c in conns:
    print (c.name)
...
embeddings = project.inference.get_azure_openai_client()

# Create a search index client using the search connection
# This client will be used to create and delete search indexes
index_client = SearchIndexClient(
    endpoint=search_connection.endpoint_url, credential=AzureKeyCredential(key=os.environ["SEARCH_KEY"])
)
...
def create_docs_from_csv(path: str, content_column: str, model: str) -> list[dict[str, any]]:
    ...
    for product in products.to_dict("records"):
        ...
        emb = embeddings.embeddings.create(input = [content], model=model)
